...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        ...
        'root://cms-xrd-global.cern.ch//store/mc/RunIIFall17MiniAODv2/DY2JetsToLL_M-50_LHEZpT_150-250_TuneCP5_13TeV-amcnloFXFX-pythia8/MINIAODSIM/MUOTrackFix_12Apr2018_94X_mc2017_realistic_v14_ext2-v1/110000/78405230-8153-E911-8AD8-AC1F6B0DE228.root'
...
process.load("SlimmedNtupleDilepton.NtuplerDilepton.CfiFile_cfi")

process.load("SlimmedNtupleDilepton.NtuplerDilepton.HLTFilter_cfi")
process.hltFilter.TriggerResultsTag = cms.InputTag("TriggerResults","","HLT")

process.load("SlimmedNtupleDilepton.NtuplerDilepton.METFilter_cfi")
...
process.load("SlimmedNtupleDilepton.TotalEventsDilepton.CfiFile_cfi")
