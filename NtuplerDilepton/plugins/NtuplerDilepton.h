// -*- C++ -*-
//
// Package:    SlimmedNtuple/NtuplerDilepton
// Class:      NtuplerDilepton
// 
/**\class NtuplerDilepton NtuplerDilepton.cc SlimmedNtuple/NtuplerDilepton/plugins/NtuplerDilepton.cc
...
class NtuplerDilepton : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
  //class NtuplerDilepton : public edm::EDAnalyzer {
   public:
      explicit NtuplerDilepton(const edm::ParameterSet&);
      ~NtuplerDilepton();
