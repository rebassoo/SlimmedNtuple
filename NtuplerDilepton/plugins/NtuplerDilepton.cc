#include "SlimmedNtupleDilepton/NtuplerDilepton/plugins/NtuplerDilepton.h"
...
//
NtuplerDilepton::NtuplerDilepton(const edm::ParameterSet& iConfig):
...
NtuplerDilepton::~NtuplerDilepton()
{
...
void
NtuplerDilepton::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
bool NtuplerDilepton::isJetLeptonAK8(double jet_eta, double jet_phi)
{
...
bool NtuplerDilepton::isJetLepton(double jet_eta, double jet_phi)
{
...
double NtuplerDilepton::calculateJERFactor(double jet_pt,double jet_eta,double jet_phi,double jet_energy,double rho,bool isAK8)
{
  double C_JER=1.;
...
void
NtuplerDilepton::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(NtuplerDilepton);
